...
class AppCubit  extends Cubit<AppStates>{
  ...
  Future<void> insertIntoDatabase({required Task task })async{
    await database?.transaction((txn){
      return txn.rawInsert("INSERT INTO tasks (title,time,date,status) VALUES('${task.title}','${task.time}','${task.date}',new)");
    }).then((value) {
